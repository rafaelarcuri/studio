...
import WhatsAppResponsesPanel from '@/components/whatsapp-responses-panel';

export default function WhatsAppResponsesPage() {
      ...
      <header className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Gerencie mensagens automáticas e respostas rápidas para agilizar o atendimento.
          </p>
        </div>
      </header>
      <WhatsAppResponsesPanel />
    </main>
  );
}
